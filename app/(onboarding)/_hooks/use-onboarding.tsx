...
const SLIDE_CONFIG = [
  { segment: 'slide-report', step: 1, next: '/(onboarding)/slide-help',   label: 'Siguiente',    replace: false },
  { segment: 'slide-help',   step: 2, next: '/(onboarding)/slide-adopt',  label: 'Siguiente',    replace: false },
  { segment: 'slide-adopt',  step: 3, next: '/(onboarding)/slide-donate', label: 'Siguiente',    replace: false },
  { segment: 'slide-donate', step: 4, next: '/(auth)/register',           label: 'Crear cuenta', replace: true  },
] as const
